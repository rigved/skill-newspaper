...
if [[ -f "secrets/mycroftai.shieldofachilles.in.key" ]] & [[ -f "secrets/mycroftai.shieldofachilles.in.crt" ]]; then
    exec daphne --endpoint "ssl:65443:privateKey=secrets/mycroftai.shieldofachilles.in.key:certKey=secrets/mycroftai.shieldofachilles.in.crt" "apiv1.asgi:application"
else
